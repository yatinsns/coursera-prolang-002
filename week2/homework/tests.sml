...
test("dates_in_month: with some months matching",
     assert_true(dates_in_month([(2012, 2, 28), (2013, 12, 1)], 2) = [(2012, 2, 28)]));

test("dates_in_month: with all months matching",
     assert_true(dates_in_month([(2012, 2, 28), (2013, 2, 1)], 2) = [(2012, 2, 28), (2013, 2, 1)]));
